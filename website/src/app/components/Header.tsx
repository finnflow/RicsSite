  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-sm z-50 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        >
          <SunLogo size={20} className="text-gray-700 group-hover:text-[#D4A88C] transition-colors -mb-0.5 hidden md:block" externalHover={isLogoHovered} />
          <SunLogo size={18} className="text-gray-700 group-hover:text-[#D4A88C] transition-colors -mb-0.5 md:hidden" externalHover={isLogoHovered} />
        ...
        <nav className="hidden md:flex gap-8 items-center">
          ...
          {isLoggedIn ? (
            <>
              <Link to="/kundenbereich" className="text-gray-700 hover:text-[#D4A88C] transition-colors">
                Kundenbereich
              </Link>
              <button 
