  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      updateElementOpacity(
        arbeitsweiseRef,
        setArbeitsweiseOpacity,
        setArbeitsweiseVisible,
        arbeitsweiseVisible,
      )
    ...
    <section className="py-16 md:py-28 bg-gradient-to-b from-[#FBF8F3] via-white to-[#FBF8F3]">
      <div className="max-w-5xl mx-auto px-6 space-y-12 md:space-y-20">
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              'linear-gradient(to bottom right, #F5EFE6, white), linear-gradient(135deg, #E8DCC4 0%, #D4A88C 50%, #C9B5A0 100%)',
        ...
        >
          ...
          >
            <Link
              to="/angebot"
              className="text-[#D4A88C] hover:text-[#C9997A] transition-colors inline-flex items-center gap-2 group"
            >
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              'linear-gradient(white, white), linear-gradient(135deg, #E8DCC4 0%, #D4A88C 50%, #C9B5A0 100%)',
            backgroundOrigin: 'border-box',
            backgroundClip: 'padding-box, border-box',
            borderWidth: '2px',
            borderStyle: 'solid',
