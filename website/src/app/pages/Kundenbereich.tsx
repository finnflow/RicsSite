    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-28 pb-20">
        ...
        <section className="max-w-4xl mx-auto px-6 mb-12 md:mb-16 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600">Schön, dass du da bist</p>
        </section>

        {/* Orientierung - Quick Links */}
        <section className="max-w-7xl mx-auto px-6 mb-16 md:mb-24">
          <h2 className="text-2xl md:text-3xl mb-8 md:mb-10 text-center text-gray-900">
            Orientierung
          </h2>
          <div className="grid md:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20 hover:shadow-[0_8px_40px_rgba(201,181,160,0.2)] transition-shadow cursor-pointer">
              ...
              <p className="text-xs md:text-sm text-gray-600">Erste Schritte & Einführung</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20 hover:shadow-[0_8px_40px_rgba(201,181,160,0.2)] transition-shadow cursor-pointer">
              ...
              <p className="text-xs md:text-sm text-gray-600">Alle Downloads & Inhalte</p>
            </div>

            {/* Kursbot */}
            <Link
              to="/kursbot"
              className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20 hover:shadow-[0_8px_40px_rgba(201,181,160,0.2)] transition-shadow cursor-pointer"
            >
              <div className="w-12 h-12 md:w-14 md:h-14 bg-[#D4A88C]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-6 h-6 md:w-7 md:h-7 text-[#D4A88C]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <p className="text-xs md:text-sm text-gray-600">Fragen zum Kursmaterial</p>
            </Link>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-6 mb-16 md:mb-24">
          <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-6">
              Basierend auf deinem Fortschritt empfehlen wir dir, mit{' '}
              <strong>Modul 1: Grundlagen</strong> zu beginnen. Nimm dir Zeit für die Übungen und
        ...
        <section className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl mb-6 md:mb-10 text-center text-gray-900">
            Hilfe & Support
          </h2>
          ...
          <div className="bg-gradient-to-br from-white to-[#F5EDE4] rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
            ...
            <div className="mt-8 md:mt-10 pt-8 md:pt-10 border-t border-[#E8DCC4]/30 text-center">
              <Link
                to="/kontakt"
                className="inline-flex items-center gap-2 text-[#D4A88C] hover:text-[#C9997A] transition-colors group"
              >
