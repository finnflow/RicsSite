        ...
        <section className="max-w-4xl mx-auto px-6 mb-16 md:mb-20 text-center">
          ...
          >
            <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-4 md:mb-6">
              Körper und Psyche sind untrennbar miteinander verbunden. Manchmal liegt der Schlüssel
              zur Veränderung in der Ernährung, manchmal in der emotionalen Arbeit – oft in beidem.
            </p>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Deshalb biete ich beide Ansätze an – einzeln oder kombiniert, je nachdem, was für dich
              passt.
            </p>
          </motion.div>
        </section>
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-start gap-3 text-sm md:text-base text-gray-700">
                  ...
                  <span>
                    ...
                    <Link
                      to="/selbststart"
                      className="underline hover:text-[#D4A88C] transition-colors"
                    >
                      Selbststart
                    </Link>{' '}
                    verfügbar
          ...
          <div className="md:hidden">
            ...
            >
              <div className="flex items-center gap-3 max-w-md mx-auto">
                ...
                >
                  <Utensils
                    className={`w-5 h-5 ${pillarState === 1 ? 'text-[#D4A88C]' : 'text-gray-500'}`}
                  />
                  <span
                    className={`text-sm ${pillarState === 1 ? 'text-gray-900 font-medium' : 'text-gray-600'}`}
                  >
                    Ernährung
                  </span>
                </button>
                ...
                >
                  <Heart
                    className={`w-5 h-5 ${pillarState === 2 ? 'text-[#D4A88C]' : 'text-gray-500'}`}
                  />
                  <span
                    className={`text-sm ${pillarState === 2 ? 'text-gray-900 font-medium' : 'text-gray-600'}`}
                  >
                    Emotional
                  </span>
                </button>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <Link to="/kontakt" className="group">
              ...
              >
                ...
                <p className="text-base text-gray-700 leading-relaxed mb-6">
                  Persönliche 1:1 Begleitung für deine individuelle Reise. Maßgeschneidert auf dich
                  und deine Situation.
                </p>
            ...
            <Link to="/selbststart" className="group">
              ...
              >
                ...
                <p className="text-base text-gray-700 leading-relaxed mb-6">
                  Info-Materialien ohne persönliche Begleitung. In deinem eigenen Tempo, wann und
