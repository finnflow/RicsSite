      ...
      <main className="pt-28 pb-20">
        ...
        <section className="max-w-4xl mx-auto px-6 mb-20 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Eigenständig arbeiten mit strukturierten Materialien – in deinem eigenen Tempo, wann und
        ...
        <section className="max-w-4xl mx-auto px-6 mb-24">
          <div className="bg-gradient-to-br from-[#FBF8F3] to-white rounded-3xl p-10 shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Du kannst jederzeit von Info-Only auf persönliche Begleitung wechseln. Deine
              bisherigen Materialien bleiben erhalten.
            </p>
            <Link
              to="/kontakt"
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
              ...
              <p className="text-sm text-gray-600">Du bekommst Zugang zum Kundenbereich</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
              ...
              <p className="text-sm text-gray-600">Lade die Materialien herunter</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
              ...
              <p className="text-sm text-gray-600">Arbeite eigenständig, wann und wie du willst</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
              ...
              <p className="text-sm text-gray-600">Bei Bedarf später zur Begleitung wechseln</p>
            </div>
          </div>
        </section>
