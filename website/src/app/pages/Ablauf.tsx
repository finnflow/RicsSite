    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-28 pb-20">
        ...
        <section className="max-w-4xl mx-auto px-6 mb-16 md:mb-20 text-center">
          ...
          >
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              Transparenz und Sicherheit von Anfang an. Hier erfährst du, wie der Weg zu einem möglichen gemeinsamen Arbeiten aussieht.
            </p>
          </motion.div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16 md:mb-24">
          <h2 className="text-3xl md:text-4xl mb-8 md:mb-12 text-center text-gray-900">Der Prozess in wenigen Schritten</h2>
          <motion.div
          ...
          >
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center h-full shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
                ...
                <p className="text-sm text-gray-600">
                  Du schreibst mir eine kurze Nachricht
                </p>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#F5EDE4] to-white rounded-2xl p-8 text-center h-full shadow-[0_4px_20px_rgba(201,181,160,0.1)] border border-[#E8DCC4]/20">
                ...
                <p className="text-sm text-gray-600">
                  Wir klären, ob es passt (ca. 30-45 Min)
                </p>
              </div>
              <div className="absolute left-full top-0 bottom-0 w-6 flex items-center justify-center">
                <ArrowRight className="w-6 h-6 text-[#D4A88C]" />
        ...
        <section className="max-w-4xl mx-auto px-6 mb-16 md:mb-24">
          ...
          >
            <h2 className="text-2xl md:text-3xl mb-4 md:mb-6 text-gray-900">Erstkontakt: Minimalangaben</h2>
        ...
        <section className="max-w-6xl mx-auto px-6 mb-16 md:mb-24">
          <h2 className="text-3xl md:text-4xl mb-8 md:mb-12 text-center text-gray-900">Das Erstgespräch</h2>
        ...
        <section className="max-w-4xl mx-auto px-6 mb-16 md:mb-24">
          ...
          >
            <h2 className="text-2xl md:text-3xl mb-4 md:mb-6 text-gray-900">Grenzen & Ausschluss</h2>
            <p className="text-base text-gray-700 leading-relaxed mb-4 md:mb-6">
              Meine Arbeit ersetzt keine medizinische oder psychotherapeutische Behandlung. Bei akuten psychischen Krisen, Essstörungen oder anderen behandlungsbedürftigen Erkrankungen kann ich nicht begleiten.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              Im Erstgespräch klären wir gemeinsam, ob eine Begleitung sinnvoll ist oder ob andere Anlaufstellen besser passen.
            </p>
          </motion.div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl mb-8 md:mb-12 text-center text-gray-900">Nach dem Erstgespräch</h2>
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-6">
                Wir vereinbaren den nächsten Schritt und besprechen, wie die Zusammenarbeit konkret aussehen kann.
              </p>
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3 text-sm md:text-base text-gray-700">
                  <Check className="w-5 h-5 text-[#D4A88C] flex-shrink-0 mt-0.5" />
